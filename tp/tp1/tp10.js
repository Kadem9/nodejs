...
// L'exercice est le même que le 8 avec les consonnes.
...
function upperCase(str) {
    ...
    for (let i = 0; i < str.length; i++) {
        ...
        // Dans notre cas nous allons tester si notre str[i] fait partie de notre constante regex donc bcdfghjklmnpqrstvwxyz
        if (regex.test(str[i])) {
